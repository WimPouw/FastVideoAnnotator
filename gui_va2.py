...
import os
import sys
from VideoAnnotator_2 import VideoAnnotator_2  # Use VideoAnnotator_2 instead of the original
...
class VideoAnnotatorGUI:
    ...
    def select_video_directory(self, mode):
        ...
        try:
            if mode == "continue":
                self.annotator = VideoAnnotator_2(video_dir, self.filled_csv_path)
            else:
                self.annotator = VideoAnnotator_2(video_dir, self.template_csv_path)
